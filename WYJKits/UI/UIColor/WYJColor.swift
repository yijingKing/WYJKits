...
public let WYJ99Color = WYJHexColor("#999999")
public let WYJ33Color = WYJHexColor("#333333")
public let WYJ66Color = WYJHexColor("#666666")
public let WYJF5Color = WYJHexColor("#F5F5F5")
public let WYJEEColor = WYJHexColor("#EEEEEE")

public func WYJHexColorFormNum(_ rgbValue: Int,_ alpha: CGFloat = 1.0) -> (UIColor) {
    return UIColor.init(rgbValue, alpha)
}

public func WYJHexColor(_ rgbValue: String,_ alpha: CGFloat = 1.0) -> (UIColor) {
    return UIColor.init(rgbValue, alpha)
}
...
//MARK: --- 换换
public extension WYJProtocol where T: UIColor {
    ///UIColor转化为16进制
    func toHex() -> String {
        var red: CGFloat = 0
        var green: CGFloat = 0
    ...
    ///颜色生成image
    func toImage(_ color : UIColor) -> UIImage {
